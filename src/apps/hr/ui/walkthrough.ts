...
export class Walkthrough {
  ...
  private keyHandler = (e: KeyboardEvent) => {
    // Ignore keys typed into form fields — otherwise space/enter on
    // an input would advance/dismiss the tour instead of editing the
    // text. This guard fires even when the tour is open (the user
    // might still type into the Find field while walking through).
